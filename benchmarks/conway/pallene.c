...
static Table * function_02(
    ...
    PALLENE_INT_FOR_LOOP_BEGIN(x4, 1, x1, 1)
    {
        ...
        {
            {
                pallene_renormalize_array(L, x5, x6, 10);
        ...
        {
            pallene_renormalize_array(L, x3, x4, 12);
...
static void function_04(
    ...
    {
        {
            pallene_renormalize_array(L, x3, x5, 26);
        ...
        {
            {
                pallene_renormalize_array(L, x6, x7, 29);
...
static void function_05(
    ...
    PALLENE_INT_FOR_LOOP_BEGIN(x7, 1, x13, 1)
    {
        ...
        {
            pallene_renormalize_array(L, x4, x7, 45);
        ...
        {
            pallene_renormalize_array(L, x3, x8, 46);
        ...
        PALLENE_INT_FOR_LOOP_BEGIN(x11, 1, x16, 1)
        {
            ...
            {
                pallene_renormalize_array(L, x9, x11, 49);
            ...
            {
                pallene_renormalize_array(L, x10, x12, 49);
...
static void function_06(
    ...
    PALLENE_INT_FOR_LOOP_BEGIN(x5, 1, x1, 1)
    {
        ...
        {
            pallene_renormalize_array(L, x3, x6, 61);
        ...
        {
            pallene_renormalize_array(L, x3, x5, 62);
            TValue *slot = &x3->array[x5 - 1];
            if (PALLENE_UNLIKELY(!ttistable(slot))) {
                pallene_runtime_tag_check_error(L,
        ...
        {
            pallene_renormalize_array(L, x3, x7, 63);
        ...
        {
            pallene_renormalize_array(L, x4, x5, 65);
        ...
        PALLENE_INT_FOR_LOOP_BEGIN(x12, 1, x2, 1)
        {
            ...
            {
                pallene_renormalize_array(L, x8, x13, 71);
            ...
            {
                pallene_renormalize_array(L, x8, x12, 72);
            ...
            {
                pallene_renormalize_array(L, x8, x14, 73);
            ...
            {
                pallene_renormalize_array(L, x9, x13, 75);
            ...
            {
                pallene_renormalize_array(L, x9, x12, 76);
            ...
            {
                pallene_renormalize_array(L, x9, x14, 77);
            ...
            {
                pallene_renormalize_array(L, x10, x13, 79);
            ...
            {
                pallene_renormalize_array(L, x10, x12, 80);
                TValue *slot = &x10->array[x12 - 1];
                if (PALLENE_UNLIKELY(!ttisinteger(slot))) {
                    pallene_runtime_tag_check_error(L,
            ...
            {
                pallene_renormalize_array(L, x10, x14, 81);
            ...
            if (x35) {
                {
                    pallene_renormalize_array(L, x11, x12, 89);
                    TValue *slot = &x11->array[x12 - 1];
                    setivalue(slot, 1);
                }
            } else {
                {
                    pallene_renormalize_array(L, x11, x12, 91);
                    TValue *slot = &x11->array[x12 - 1];
                    setivalue(slot, 0);
                }
            }
...
int luaopen_benchmarks_conway_pallene(lua_State *L)
{
    luaL_checkversion(L);
